...
<div class="w-full px-4 py-6 md:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800">Transaksi Pembelian Pestisida</h1>
        <p class="text-gray-600">Daftar semua transaksi pembelian pestisida dari pemasok.</p>
        ...
        <div class="bg-white rounded-lg shadow overflow-x-auto">
            <table class="min-w-full text-sm text-left border border-gray-200">
                ...
                <tbody>
                    <?php if (!empty($trx)) : ?>
                        <?php $i = 1; foreach ($trx as $row) : ?>
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2 border"><?= htmlspecialchars($row['pesticide_name']) ?></td>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="7" class="text-center py-4 text-gray-500">Belum ada transaksi pestisida.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
