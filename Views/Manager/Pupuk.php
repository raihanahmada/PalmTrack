...
<div class="w-full px-4 py-6 md:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800">Data Stok Pupuk</h1>
        <p class="text-gray-600">Berikut adalah daftar semua pupuk yang tersedia dalam sistem.</p>
        ...
        <div class="bg-white rounded-lg shadow overflow-x-auto">
            <table class="min-w-full text-sm text-left border border-gray-200">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5" class="text-center py-4 text-gray-500">Data pupuk belum tersedia.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
